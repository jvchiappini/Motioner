                    ...
                    egui::Frame::window(ui.style())
                        ...
                        .show(ui, |ui| {
                            ui.vertical_centered(|ui| {
                                ...
                                ui.label(
                                    egui::RichText::new("Motion Graphics DSL Editor")
                                        .italics()
                                        .weak(),
                                );
                                ui.add_space(25.0);
                            ...
                            ui.vertical_centered(|ui| {
                                ...
                                if ui
                                    .add_enabled(!state.project_path_input.is_empty(), btn)
                                    .clicked()
                                {
                                    ...
                                    if path.exists() && path.is_dir() {
                                        ...
                                        state.path_validation_error =
                                            Some("The specified path does not exist.".to_string());
                                    } else {
                                        state.path_validation_error = Some(
                                ...
                                if let Some(err) = &state.path_validation_error {
                                    ...
                                    ui.label(
                                        egui::RichText::new(
                                            "Please select a project folder to continue",
                                        )
                                        .size(12.0)
                                        .color(egui::Color32::from_rgb(255, 100, 100)),
                                    );
