...
pub fn show(ctx: &egui::Context, state: &mut AppState) {
    ...
    let backdrop_painter = ctx.layer_painter(egui::LayerId::new(
        egui::Order::Foreground,
        egui::Id::new("welcome_backdrop"),
    ));
    backdrop_painter.rect_filled(screen_rect, 0.0, egui::Color32::from_black_alpha(200));
    ...
    egui::Area::new("welcome_modal_area")
        ...
        .show(ctx, |ui| {
            ...
            frame.show(ui, |ui| {
                ...
                // Orb 1: Violet
                let center1 = bg_rect.center()
                    + egui::vec2(
                        (time as f32 * 0.3).sin() * 80.0,
                        -100.0 + (time as f32 * 0.45).cos() * 50.0,
                    );
                ...
                // Orb 2: Deep Blue
                let center2 = bg_rect.center()
                    + egui::vec2(
                        180.0 + (time as f32 * 0.25).cos() * 60.0,
                        150.0 + (time as f32 * 0.4).sin() * 70.0,
                    );
                abstract_painter.circle_filled(
                    center2,
                    240.0,
                    ...
                    .show(ui, |ui| {
                        ...
                        ui.vertical_centered(|ui| {
                            ...
                            let img_rect = egui::Rect::from_center_size(
                                rect.center(),
                                egui::vec2(logo_size, logo_size) * logo_scale,
                            );
                            ...
                            group_frame.show(ui, |ui| {
                                ...
                                ui.horizontal(|ui| {
                                    let btn_rect = ui.add(
                                        egui::Button::new(
                                            egui::RichText::new("📁 Browse").strong().size(14.0),
                                        )
